...
import RecommendCard from '@/ComponentCard/MyInfoHome/RecommendCard.vue';
...
// Mock 数据
const mockGoodsData = [
    { id: '2', name: '躺平的猫猫头', description: 'oc变成邪恶人外了？dawdadwdadwadwd', price: '199.00', is_sold: '2', image: '/02_daring.ico', userimage: '/02_daring.ico' },
    { id: '3', name: '测试商品3', description: '这是测试商品3', price: '299.00', is_sold: '3', image: '/026_daring.ico', userimage: '/026_daring.ico' },
    { id: '4', name: '测试商品4', description: '这是测试商品4', price: '399.00', is_sold: '2', image: '/027_daring.ico', userimage: '/027_daring.ico' },
    { id: '5', name: '测试商品5', description: '这是一个较长的测试商品描述内容，用于验证文本截断效果', price: '499.00', is_sold: '10', image: '/TT (1).jpg', userimage: '/TT (5).jpg' },
    { id: '6', name: '测试商品6', description: '这是一个较长的测试商品描述内容，用于验证文本截断效果', price: '499.00', is_sold: '10', image: '/TT (2).jpg', userimage: '/TT (4).jpg' },
    { id: '7', name: '测试商品7', description: '这是一个较长的测试商品描述内容，用于验证文本截断效果', price: '499.00', is_sold: '10', image: '/TT (3).jpg', userimage: '/TT (1).jpg' },
    { id: '8', name: '测试商品8', description: '这是一个较长的测试商品描述内容，用于验证文本截断效果', price: '499.00', is_sold: '10', image: '/TT (4).jpg', userimage: '/TT (7).jpg' },
    { id: '9', name: '测试商品9', description: '这是一个较长的测试商品描述内容，用于验证文本截断效果', price: '499.00', is_sold: '10', image: '/TT (5).jpg', userimage: '/TT (11).jpg' },];
...
const handleScroll = () => {
    ...
    localStorage.setItem('SCROLL_RECENT_POS_KEY', scrollTop.toString());
};
...
const refreshData = async () => {
    try {
        ...
        localStorage.setItem('SCROLL_RECENT_POS_KEY', '0');
        isTouchingTop.value = false;
        pullDistanceTop.value = 0;
        console.log("数据刷新完成！");
    } catch (error) {
...
const loadMoreData = async () => {
    ...
    try {
        ...
        if (cardsGridRef.value) {
            ...
            localStorage.setItem('SCROLL_RECENT_POS_KEY', prevScrollTop.toString());
        }
    } catch (error) {
        page.value--;
...
onActivated(() => {
    ...
    const savedPos = Number(localStorage.getItem('SCROLL_RECENT_POS_KEY')) || 0;
...
.main-div {
    ...
    .cards-grid {
        ...
        grid-template-columns: repeat(auto-fill, minmax(clamp(140px, 40vw, 200px), 2fr));
