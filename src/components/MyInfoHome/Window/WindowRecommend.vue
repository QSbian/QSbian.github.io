...
// Mock 数据
const mockGoodsData = [
    { id: '2', name: 'QSbian', description: 'oc变成邪恶人外了？dawdadwdadwadwd', price: '199.00', is_sold: '2', image: '/02_daring.ico', userimage: '/02_daring.ico' },
...
<template>
    <div class="main-div">
        ...
        <div class="cards-grid" @touchstart.passive="handleTouchStart" @touchmove.passive="handleTouchMove"
            ...
            <div v-show="!hasMoreData && responseData.length > 0" class="no-more-data">
