...
const mockGoodsData = [
    { id: '2', name: '特殊矩阵', appriciation: '4.1', state: '空闲', image: ['/02_daring.ico', '/026_daring.ico'], userimage: '/TT (6).jpg', havePrice: false },
    { id: '3', name: '测试商品3', appriciation: '4.4', state: '空闲', image: ['/TT (9).jpg'], userimage: '/TT (2).jpg', havePrice: false },
    { id: '4', name: '测试商品4', appriciation: '5.0', state: '空闲', image: ['/TT (1).jpg'], userimage: '/027_daring.ico', havePrice: false },
    { id: '5', name: '测试商品5', appriciation: '5.0', state: '空闲', image: ['/TT (4).jpg', '/TT (2).jpg', '/TT (6).jpg'], userimage: '/TT (4).jpg', havePrice: false },
