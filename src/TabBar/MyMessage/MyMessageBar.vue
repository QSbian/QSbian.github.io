...
const windowTabBarList = ref([
    { id: 0, text: '会话', icon: 'conversation', activeIcon: 'conversation-filled', color: '#8a8a8a', activeColor: '#3e7bfa', size: 20 },
    { id: 1, text: '商铺', icon: 'shop', activeIcon: 'shop-filled', color: '#8a8a8a', activeColor: '#3e7bfa', size: 20 },
]);

</script>

<template>
    <div class="tabBar" data-v-inspector="src/TabBar/MyMessage/MyMessageBar.vue:26:5">
